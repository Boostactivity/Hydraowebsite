...
export function TestimonialsPage({ navigate }: TestimonialsPageProps) {
  const testimonials = [
    ...
    },
    {
      ...
      text: "Commande passée un lundi, plombier chez moi le vendredi suivant. Installation en moins d'1h chrono, tout fonctionne parfaitement. Le SAV a répondu à toutes mes questions techniques en moins de 24h.",
      verified: true,
