...
function PaymentMethodsSection({ formData, setFormData }: { formData: any; setFormData: (data: any) => void }) {
  const paymentMethods = [
    { id: 'card', name: 'Carte bancaire', logos: ['💳', 'Visa', 'Mastercard', 'CB'] },
    { id: 'paypal', name: 'PayPal', logos: ['PayPal'] },
    { id: 'applepay', name: 'Apple Pay', logos: [''] }
  ];
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="px-4 py-2 bg-white rounded-lg border border-gray-200">
            <svg className="h-6" viewBox="0 0 48 16" fill="none">
              <path d="M18.5 0L14.8 16H11.2L14.9 0H18.5Z" fill="#1434CB"/>
              <path d="M32.8 10.4L34.6 4.8L35.7 10.4H32.8ZM37.5 16H40.9L37.8 0H34.8C34.1 0 33.5 0.4 33.2 1L27.8 16H31.7L32.5 13.8H37.2L37.5 16Z" fill="#1434CB"/>
              <path d="M11.1 10.8L11.5 8.4C11.3 8.4 10.6 8.2 9.9 8.2C8.7 8.2 8.5 8.8 8.5 9.1C8.5 9.7 9.4 10 10 10.2C11.9 10.8 13.4 11.8 13.4 13.7C13.4 16.2 11.4 17.5 8.9 17.5C7.2 17.5 5.6 17.1 5.6 17.1L6.1 14.5C6.1 14.5 7.8 15 9 15C9.8 15 10.5 14.7 10.5 14C10.5 13.3 9.5 13 8.8 12.7C7 12 5.6 11.1 5.6 9.2C5.6 6.9 7.5 5.5 10.3 5.5C11.8 5.5 13 5.9 13 5.9L12.5 8.3C12.5 8.3 11.4 7.9 10.3 7.9C9.3 7.9 8.7 8.3 8.7 8.9C8.7 9.4 9.4 9.7 10.3 10C12 10.5 13.4 11.4 13.4 13.2C13.4 15.6 11.5 17 9 17C7.4 17 5.8 16.6 5.8 16.6L6.3 14C6.3 14 7.9 14.5 9.2 14.5C10.1 14.5 10.7 14.1 10.7 13.5C10.7 12.9 9.9 12.6 9.1 12.3C7.4 11.7 6 10.8 6 9C6 6.8 7.8 5.5 10.5 5.5C12 5.5 13.2 5.9 13.2 5.9L12.7 8.3C12.7 8.3 11.7 7.9 10.6 7.9C9.5 7.9 9 8.4 9 8.9C9 9.5 9.8 9.8 10.6 10.1C12.3 10.7 13.7 11.6 13.7 13.4C13.7 15.8 11.8 17.2 9.2 17.2C7.5 17.2 6 16.8 6 16.8L6.5 14.2C6.5 14.2 8.1 14.7 9.4 14.7C10.3 14.7 10.9 14.3 10.9 13.7C10.9 13 10 12.7 9.3 12.4C7.6 11.8 6.2 10.9 6.2 9.1C6.2 7 8 5.6 10.7 5.6C12.1 5.6 13.4 6 13.4 6L12.9 8.4C12.9 8.4 11.8 8 10.7 8C9.6 8 9.1 8.5 9.1 9C9.1 9.6 10 9.9 10.8 10.2L11.1 10.8Z" fill="#1434CB"/>
            </svg>
          </div>
          {/* Mastercard */}
          <div className="px-4 py-2 bg-white rounded-lg border border-gray-200">
            <svg className="h-6" viewBox="0 0 48 30" fill="none">
              ...
              <path d="M24 7.5C22 9.5 20.8 12.5 20.8 15.5C20.8 18.5 22 21.5 24 23.5C26 21.5 27.2 18.5 27.2 15.5C27.2 12.5 26 9.5 24 7.5Z" fill="#FF5F00"/>
            </svg>
          </div>
          {/* PayPal */}
          <div className="px-4 py-2 bg-white rounded-lg border border-gray-200">
