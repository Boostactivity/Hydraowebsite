                          ...
                          <div key={section.title} className={sectionIdx > 0 ? 'mt-2 pt-2 border-t border-gray-100' : ''}>
                            ...
                            {section.items.map((item, idx) => (
                              <motion.button
                                ...
                                className="w-full text-left px-3 py-1.5 rounded-lg hover:bg-[#FAF8F5] transition-colors text-sm text-gray-700 hover:text-gray-900"
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 space-y-1 max-h-[calc(100vh-8rem)] overflow-y-auto">
                ...
                <div key={section.title} className="mt-3">
                  ...
                  {section.items.map((link, itemIdx) => (
                    <motion.button
                      ...
                      className="w-full text-left px-4 py-2.5 rounded-xl hover:bg-[#FAF8F5] transition-colors text-sm"
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
              ...
              <motion.button
                ...
                className="w-full text-left px-4 py-3 rounded-xl hover:bg-[#FAF8F5] transition-colors mt-2"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              <motion.button
                ...
                className="w-full text-left px-4 py-3 rounded-xl hover:bg-[#FAF8F5] transition-colors"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: (menuStructure.decouvrir.sections.reduce((acc, section) => acc + section.items.length, 0) + 2) * 0.03 }}
              >
